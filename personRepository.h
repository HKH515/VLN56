...
class PersonRepository
{
    ...
    public:
        ...
        vector<string> query(string column, string dataQuery, string sort_column, string order); //Fetches all lines matching query (substring search)
        vector<string> query_exact(string column, string dataQuery, string sort_column, string order); //Fetches all lines matching query exactly
